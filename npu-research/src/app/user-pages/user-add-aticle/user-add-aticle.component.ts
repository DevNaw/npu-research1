...
export class UserAddAticleComponent {
  ...
  //   const requiredFields: { key: keyof typeof d; label: string }[] = [
  //     { key: 'title_th', label: 'ชื่อบทความ (ภาษาไทย)' },
  //     { key: 'title_en', label: 'ชื่อบทความ (ภาษาอังกฤษ)' },
  //     { key: 'article_type', label: 'ประเภทบทความ' },
  //     { key: 'journal_name', label: 'ชื่อวารสาร' },
  //     { key: 'pages', label: 'หน้า' },
  //     { key: 'year_published', label: 'ปีที่พิมพ์' },
  //     { key: 'volume', label: 'ปีที่ (Volume)' },
  //     { key: 'volume_no', label: 'ฉบับที่' },
  //     { key: 'doi', label: 'DOI' },
  //   ];
  ...
  //       icon: 'warning',
  //       title: 'กรอกข้อมูลไม่ครบ',
  //       html: `กรุณากรอกข้อมูลต่อไปนี้ให้ครบ:<br><br>${missing.join('<br>')}`,
  //     });
  //     return false;
  //   }
