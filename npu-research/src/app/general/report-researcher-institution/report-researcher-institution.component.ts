...
@Component({
  selector: 'app-report-researcher-institution',
  standalone: false,
  templateUrl: './report-researcher-institution.component.html',
  styleUrl: './report-researcher-institution.component.css',
})
export class ReportResearcherInstitutionComponent {
  pageSize = 10;
  currentPage = 1;
  searchText: string = '';
  today = new Date();
  ...
  documents: DocumentReport[] = [
    ...
    {
      title: 'คณะวิทยาการจัดการและเทคโนโลยีสารสนเทศ',
      academic: 62,
    },
  ];
  ...
  exportExcel() {
    ...
    XLSX.writeFile(workbook, 'รายงานข้อมูลนักวิจัยแยกตามหน่วยงาน.xlsx');
  }
