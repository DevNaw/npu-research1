...
export interface DashboardData {
  ...
  statistic_researcher: StatisticResearcher;
}
...
export interface StatisticResearcher {
  total_researcher_with_output: number;
  total_volume: number;
  total_volume_article: number;
  total_volume_innovation: number;
}
